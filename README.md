...
The Adeept_Robot_HAT operates based on the Raspberry Pi. It has many interfaces. Through these interfaces, sensors and electronic hardware modules can be connected to the board to achieve more functions. 
